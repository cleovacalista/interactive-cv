...
<a href="mailto:ccleova05@example.com" class="bg-purple-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-300 inline-block mb-12">
...
Cleova Calista Dibuat dengan </p>
</div>
</footer>
</template>
