...
<div class="w-1/2 pr-8 text-right"><p class="font-semibold text-purple-600">{{ edu.period }}</p><h3 class="text-2xl font-bold text-gray-800">{{ edu.institution }}</h3><p class="text-gray-600">{{edu.major }}</p></div>
...
<div class="w-1/2 pl-8 text-left"><p class="font-semibold text-purple-600">{{ edu.period }}</p><h3 class="text-2xl font-bold text-gray-800">{{ edu.institution }}</h3><p class="text-gray-600">{{edu.major }}</p></div>
</div>
</div>
</div>
</div>
