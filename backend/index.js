...
app.post('/api/send-email', async (req, res) => {
  ...
  const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
      user: 'cleovacalistaazizakayviar@students.amikom.ac.id', // <-- GANTI DENGAN EMAILMU
      pass: 'lbjt guao paoc dnks' // <-- GANTI DENGAN APP PASSWORD
    }
  });
  ...
  const mailOptions = {
    ...
    to: 'cleovacalistaazizakayviar@students.amikom.ac.id', // Penerima (emailmu sendiri)
